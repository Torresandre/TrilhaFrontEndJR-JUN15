  ...
  return(
    ...
    <Card className="w-[80%] mt-3 border-red-600">
      ...
      <CardContent className="w-full">
        ...
        <p className="pb-2">
          Joguei minha primeira partida de rpg aos 14 anos e desde então nunca mais parei e hoje 25 anos depois ainda é um dos meus hobbys prefeirido, principalente agora que tenho meu filho mais velho como parceiro de jogo.
        </p>
        <h4 className="text-red-600 text-lg pb-2">Motocicletas</h4>
        <p className="pb-2">
          Minha paixão por motos vem desde criança quando ainda brincava que inha bicicleta era uma motocicleta, quando pude comprei uma moto velha mesmo e comecei a customizá-la, sim também é um de meus hobbys   
        </p>
